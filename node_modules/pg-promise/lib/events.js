...
const $events = {
     ...
     *         // dc = database context;
     *         obj.addImage = data => {
     *             return obj.one('INSERT INTO images(data) VALUES($1) RETURNING id', data);
     *         }
     *     }
     * };
     *
     ...
     * // For a complete example see https://github.com/vitaly-t/pg-promise-demo
     *
     * // Users repository;
