 ...
 * @typedef TaskContext
 * @description
 * Task/Transaction Context used inside tasks (method {@link Database#task Database.task}) and transactions (method {@link Database#tx Database.tx}).
 *
 * Properties `context`, `parent`, `level`, `dc`, `isTX`, `tag`, `start` and `isFresh` are set just before the operation has started,
